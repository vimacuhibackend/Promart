using Autofac;
using MediatR;
using Promart.Api.Application.Behaviors;
using Promart.Api.Application.Commands;
...
namespace Promart.Api.Infrastructure.AutofacModules
{
    public class MediatorModule : Autofac.Module
    {
        protected override void Load(ContainerBuilder builder)
        {
            ...
            builder.RegisterAssemblyTypes(typeof(CrearClienteCommand).GetTypeInfo().Assembly)
